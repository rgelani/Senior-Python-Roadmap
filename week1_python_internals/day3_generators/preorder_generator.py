...
def preorder_traversal_generator(root):
    """
    Performs an Pre-order traversal of a binary tree using a generator.
...
if __name__ == "__main__":
    ...
    print("Pre-Order Traversal (Generator Output):")
    
    # We loop over the generator object to consume the values
    traversal_gen = preorder_traversal_generator(root)
    ...
    lazy_gen = preorder_traversal_generator(root)
